...
class _NewsListState extends State<NewsList> {
  ...
  // String baseApi = 'https://newsapi.org/v2/top-headlines/sources?category=business&apiKey=d46a85d171df4329a549a7e776be741f';

  int _selectedIndex = 0;
 final List<Widget> _widgetOptions = <Widget>[
    NewsPage(), // Your Home page widget
    ChatView(), // Your Chatbot page widget
    // /SearchPage(), // Your Search page widget
 ];
 ...
 // Method to handle the selection of an icon in the bottom navigation bar
    ...
    // if (index == 1) { // Assuming the Chatbot icon is at index 1
    //  navigatorKey.currentState?.push(MaterialPageRoute(builder: (context) => ChatView())); // Updated navigation
    // }
 }
